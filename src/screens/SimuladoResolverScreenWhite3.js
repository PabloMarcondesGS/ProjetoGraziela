...
function SimuladoResolverScreenWhite3(props) {
  return (
      ...
      <View style={styles.rect1}>
        ...
        <View style={styles.rect3}>
          <Text style={styles.daniloAugusto2}>
            Resposta comentada do professor informando os detalhes da questão e
            seus rspectivos comentários.
          </Text>
        </View>
      ...
      <View style={styles.rect2}>
        <View style={styles.icon1Row}>
          <FontAwesomeIcon
            ...
            style={styles.icon1}
          ></FontAwesomeIcon>
          <View style={styles.questao02De38Column}>
            <Text style={styles.questao02De38}>Questão 02 de 38</Text>
            <Text style={styles.leiN1}>Certas: 1 Erradas: 0</Text>
          </View>
        </View>
      </View>
    </View>
...
export default SimuladoResolverScreenWhite3;
