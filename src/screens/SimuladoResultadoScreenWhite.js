...
function SimuladoResultadoScreenWhite(props) {
  return (
    <View style={styles.container}>
      <View style={styles.rect2}>
        <Text style={styles.simuladoConcluido}>Simulado Concluído</Text>
        <Image
          source={require("../assets/images/Circular_chart_diagram_infographic_pie_chart_pie_graph_statistics-512.png")}
          resizeMode="contain"
          style={styles.image}
        ></Image>
...
export default SimuladoResultadoScreenWhite;
